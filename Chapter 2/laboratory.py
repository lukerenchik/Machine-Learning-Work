...
#Example for Three Functions with Very Different Expected Rewards, Highlights the need for exploration.
...
#Test for 10 moving signals, these can be modified to understand different behavior
